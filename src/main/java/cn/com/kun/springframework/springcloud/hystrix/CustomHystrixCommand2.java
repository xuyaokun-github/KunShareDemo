 ...
 * 因为对象是新的，计数就是从0开始！
 *
 * 注意，假如这个类定义成单例，它也一样，只能调用一次execute方法
 *
 * author:xuyaokun_kzx
 * date:2021/8/23
 * desc:
*/
@Component
public class CustomHystrixCommand2 extends HystrixCommand {

    private final static Logger LOGGER = LoggerFactory.getLogger(CustomHystrixCommand2.class);
    ...
    private static Setter buildSetter() {
        ...
        Setter setter = Setter.withGroupKey(HystrixCommandGroupKey.Factory.asKey("CmmandGroupKey"))
