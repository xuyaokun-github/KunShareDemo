...
@Service
public class CaffeineCacheDemoService {

    private final static Logger logger = LoggerFactory.getLogger(CaffeineCacheDemoService.class);
    ...
    public ResultVo test1(ResultVo req){
