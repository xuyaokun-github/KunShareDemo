...
public abstract class RedisPriorityQueue<T> {
    ...
    public void push(T obj, int priority){
         ...
         */
        redisTemplateHelper.zsetAdd(getKey(), JacksonUtils.toJSONString(obj), priority);
    }
    ...
    public <T> T pop(Class clazz){
         ...
         */
        Set<String> result = redisTemplateHelper.zsetReverseRange(getKey(),0, 0);
    ...
    public Long count(){
        ...
        return redisTemplateHelper.zsetSize(getKey());
    }
