...
public class DesensitizationHelper {
     ...
     * @return
     */
    public Object desensitization(Object body) throws Exception {
        ...
        for (Field field : fields){
            ...
            if (desensitizationField != null){
                ...
                //拿到旧值
                String oldValue = (String) getMethod.invoke(body);
                if (oldValue != null && oldValue instanceof String){
                    //只做字符串的处理
                    Method setMethod = pd.getWriteMethod();
                    String newValue = oldValue.replaceAll(expression, replace);
        ...
        String newResultBodyStr = JacksonUtils.toJSONString(body);
