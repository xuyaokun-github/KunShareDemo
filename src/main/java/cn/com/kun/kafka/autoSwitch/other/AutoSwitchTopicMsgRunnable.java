 ...
 * desc:
*/
public class AutoSwitchTopicMsgRunnable implements Runnable{

    private AutoSwitchMsgProcessor processor;

    private RecordWrapper recordWrapper;

    public AutoSwitchTopicMsgRunnable(AutoSwitchMsgProcessor msgCacheMsgProcessor, RecordWrapper record) {
