...
@Configuration
public class KafkaDataStatMonitorDemoProducerConfig {

    @Autowired
    KafkaProducerProperties kafkaProducerProperties;

    @Bean
    public Producer<String, String> dataStatMonitorTopicKafkaProducer(){

        Properties props = buildProducerProperties();
        // 2. 构建拦截链
        List<String> interceptors = new ArrayList<>();
        interceptors.add("cn.com.kun.kafka.dataStatMonitor.stat.interceptor.DataStatProducerInterceptor");
